...
func (p *PostHandler) GetPost(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		InternalServer(p.app.Logger, rw, "Unable to render template", err)
		return
	}
}
...
func (p *PostHandler) PostCreatePost(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		InternalServer(p.app.Logger, rw, "Unable to create post", err)
		return
	}
...
func (p *PostHandler) PostEditPost(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		InternalServer(p.app.Logger, rw, "Unable to edit post", err)
		return
	}
...
func (p *PostHandler) GetDeletePost(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		InternalServer(p.app.Logger, rw, "Unable to delete post", err)
		return
	}
